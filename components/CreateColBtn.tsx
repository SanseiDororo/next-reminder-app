...
const CreateColBtn = () => {
  ...
  return (
    <div className="w-full rounded-md bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 p-[1px]">
      ...
      >
        <span className="bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-700 hover:to-orange-800 bg-clip-text text-transparent">
          Create collection
        </span>
      </Button>
